...
--
-- Definition of table `employeedata`
--
...
INSERT INTO `employeedata` (`ID`,`name`,`phone`,`address`,`department`) VALUES 
 (1,'Nikhil','9012091292','cosmos','eai/bpm'),
 (2,'balyan','9012934902','budh_vihar','cis'),
 (3,'Nikhil_balyan','9012902387','budh_vihar','cis');
...
CREATE DATABASE IF NOT EXISTS one_to_many;
USE one_to_many;
...
/*!40000 ALTER TABLE `campusmind` DISABLE KEYS */;
INSERT INTO `campusmind` (`mId`,`track`,`userName`) VALUES 
 (1,'EAI','Nikhil0'),
 (2,'EAI','Nikhil1'),
 (3,'EAI','Nikhil2'),
 (4,'EAI','Nikhil3'),
